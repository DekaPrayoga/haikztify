    ...
    <nav className="sidebar">
      ...
      <div className="logo" onClick={() => navigate('/')}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <img src="/logo.svg" alt="HaikZTIFY" width="36" height="36"
      ...
      <ul className="nav-menu">
        ...
        >
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path d="M12.5 3.247a1 1 0 0 0-1 0L4 7.577V20h4.5v-6a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v6H20V7.577l-7.5-4.33zm-2-1.732a3 3 0 0 1 3 0l7.5 4.33a2 2 0 0 1 1 1.732V21a1 1 0 0 1-1 1h-6.5a1 1 0 0 1-1-1v-7h-3v7a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V7.577a2 2 0 0 1 1-1.732l7.5-4.33z"/>
          </svg>
          <span>Home</span>
        </li>
        <li
        ...
        <div className="library-scroll">
          ...
          <div className="lib-item" onClick={() => navigate('/liked')}>
            ...
            <div>
              ...
              <div className="lib-meta">Playlist • {likedIds.size} lagu</div>
            </div>
          </div>
              ...
              {pl.tracks.length > 0 && pl.tracks[0].cover ? (
                ...
                <div className="lib-cover custom-playlist-cover" style={{ background: '#282828', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <svg viewBox="0 0 24 24" fill="#b3b3b3" width="20" height="20">
                    <path d="M6 3h12v2H6zm0 4h12v2H6zm0 4h8v2H6zm10 0h2v5h-2zm-3 5h8v2h-8z"/>
                  </svg>
                </div>
              )}
              <div>
                <div className="lib-name">{pl.name}</div>
                <div className="lib-meta">Playlist • {pl.tracks.length} lagu</div>
              </div>
            </div>
          ))}
        ...
        {isLoggedIn && user && (
          <div
            style={{
              ...
              borderRadius: 8, cursor: 'pointer', transition: 'background 0.15s', position: 'relative',
            }}
          ...
          >
            {user.avatar ? (
              ...
              <div style={{ width: 32, height: 32, borderRadius: '50%', background: '#535353', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <svg viewBox="0 0 24 24" fill="#b3b3b3" width="18" height="18">
